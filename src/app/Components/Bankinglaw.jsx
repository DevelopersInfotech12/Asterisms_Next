...
const Bankinglaw = () => {
  const keyHighlights = [
    {
      ...
      description: "Advised and represented SBI in high-value loan restructuring cases, ensuring compliance with RBI guidelines and securing recoveries through strategic settlements.",
      type: "Loan Restructuring"
    },
    {
      company: "ICICI Bank Ltd.",
      description: "Successfully represented ICICI Bank in proceedings before the Debt Recovery Tribunal (DRT) and National Company Law Tribunal (NCLT) for recovery of secured debts.",
      type: "Debt Recovery"
    },
    {
      company: "HDFC Bank",
      description: "Advised HDFC Bank in drafting and negotiating syndicated loan agreements, including cross-border financing transactions involving multinational corporations.",
      type: "Syndicated Loans"
    },
    {
      company: "Punjab National Bank",
      description: "Represented PNB in cases of fraud investigation, non-performing assets (NPAs), and regulatory compliance disputes before various judicial and regulatory authorities.",
  ...
  const expertise = [
    ...
    "Debt Recovery & DRT/NCLT Matters",
    "High-value Loan Restructuring",
    "Cross-border Banking Transactions",
    "Non-Performing Asset (NPA) Management",
    "Litigation before Supreme Court & High Courts"
  ];

  const stats = [
    { number: "500+", label: "Banking Cases" },
    { number: "₹1L Cr+", label: "Advised" },
    { number: "95%", label: "Recovery Rate" },
    { number: "25+", label: "Banks & NBFCs" }
  ];
    ...
    <div style={{ fontFamily: "Georgia, 'Times New Roman', serif", background: "#0f0e0c", color: "#f5f0e8", minHeight: "100vh" }}>
      ...
      <div style={{ background: "linear-gradient(160deg, #0f0e0c 60%, #1a1710 100%)", padding: "3rem 2rem 2rem", borderBottom: "1px solid #2a2418" }}>
        <p style={{ fontFamily: "Arial, sans-serif", fontSize: "11px", letterSpacing: "0.18em", color: "#c9a84c", textTransform: "uppercase", marginBottom: "1rem" }}>
          Asterisms Legal · Banking Law Practice
        </p>
        ...
        <p style={{ fontFamily: "Arial, sans-serif", fontSize: "0.95rem", color: "#9e9484", maxWidth: "520px", lineHeight: 1.7, margin: "1rem 0 0" }}>
          Trusted advisors for India's leading banks and financial institutions — DRT, NCLT, High Courts & the Supreme Court of India.
        </p>
      </div>
        ...
        <div style={{ marginBottom: "3rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2rem" }}>
            <p style={{ fontFamily: "Arial, sans-serif", fontSize: "0.92rem", color: "#9e9484", lineHeight: 1.8, margin: 0 }}>
              Our firm has <strong style={{ color: "#c9a84c" }}>deep expertise</strong> in banking and financial services laws, representing major banks, NBFCs, and multinational corporations in a wide range of transactions and disputes.
            </p>
            <p style={{ fontFamily: "Arial, sans-serif", fontSize: "0.92rem", color: "#9e9484", lineHeight: 1.8, margin: 0 }}>
              We provide end-to-end support in <strong style={{ color: "#c9a84c" }}>debt recovery, loan restructuring, fraud investigation,</strong> and cross-border transactions, ensuring compliance with RBI regulations.
            </p>
          </div>
        </div>
          ...
          <div style={{ border: "1px solid #2a2418" }}>
            <div style={{ background: "#141210", padding: "1.2rem 1.6rem", borderBottom: "1px solid #2a2418" }}>
              <h3 style={{ margin: 0, fontSize: "0.75rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "#c9a84c", fontFamily: "Arial, sans-serif", fontWeight: 400 }}>
                Major Transactions & Litigations
              </h3>
            </div>
