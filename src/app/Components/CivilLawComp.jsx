...
const CivilLawComp = () => {
  const keyHighlights = [
    { company: "Property & Title Disputes", description: "Successfully handled complex property disputes, title verification matters, and injunction suits, ensuring protection of ownership rights.", type: "Property Law" },
    { company: "Contractual Disputes", description: "Represented clients in breach of contract cases, recovery suits, and commercial disputes, ensuring effective enforcement of contractual rights.", type: "Contract Law" },
    { company: "Recovery & Money Suits", description: "Advised and represented clients in recovery proceedings, summary suits, and execution matters for effective debt recovery.", type: "Recovery Matters" },
    { company: "Injunctions & Civil Remedies", description: "Secured interim and permanent injunctions, specific performance decrees, and other civil remedies to safeguard client interests.", type: "Civil Remedies" }
  ];
  ...
  const expertise = [
    ...
    "Partition & Family Property Matters",
    "Execution & Recovery Proceedings"
  ];

  const stats = [
    { number: "450+", label: "Civil Cases" },
    { number: "92%", label: "Successful Outcomes" },
    { number: "10+", label: "Years Experience" },
    { number: "300+", label: "Disputes Resolved" }
  ];
  ...
  return (
    <div style={{ fontFamily: "Georgia, 'Times New Roman', serif", background: "#0f0e0c", color: "#f5f0e8", minHeight: "100vh" }}>
      <div style={{ background: "linear-gradient(160deg, #0f0e0c 60%, #1a1710 100%)", padding: "3rem 2rem 2rem", borderBottom: "1px solid #2a2418" }}>
        <p style={{ fontFamily: "Arial, sans-serif", fontSize: "11px", letterSpacing: "0.18em", color: "#c9a84c", textTransform: "uppercase", marginBottom: "1rem" }}>Asterisms Legal · Civil Law Practice</p>
        <h1 style={{ fontSize: "clamp(1.8rem, 4vw, 2.6rem)", fontWeight: 400, color: "#f5f0e8", lineHeight: 1.2, margin: "0 0 0.5rem" }}>
          Precision. Integrity.<br /><em style={{ color: "#c9a84c" }}>Outcome-Driven</em><br />Civil Counsel.
        </h1>
        <p style={{ fontFamily: "Arial, sans-serif", fontSize: "0.95rem", color: "#9e9484", maxWidth: "520px", lineHeight: 1.7, margin: "1rem 0 0" }}>
          Effective legal solutions for civil disputes and rights enforcement across all courts.
        </p>
      </div>
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "2.5rem 2rem" }}>
        ...
        <div style={{ marginBottom: "3rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2rem" }}>
            <p style={{ fontFamily: "Arial, sans-serif", fontSize: "0.92rem", color: "#9e9484", lineHeight: 1.8, margin: 0 }}>Our firm provides comprehensive legal services in <strong style={{ color: "#c9a84c" }}>Civil Law</strong>, handling disputes related to property, contracts, recovery, and civil rights enforcement.</p>
            <p style={{ fontFamily: "Arial, sans-serif", fontSize: "0.92rem", color: "#9e9484", lineHeight: 1.8, margin: 0 }}>We deliver <strong style={{ color: "#c9a84c" }}>practical and result-oriented solutions</strong>, representing clients before Civil Courts, District Courts, and High Courts.</p>
          </div>
        </div>
        <div style={{ marginBottom: "3rem" }}>
        ...
        <div>
          ...
          <div style={{ border: "1px solid #2a2418" }}>
            <div style={{ background: "#141210", padding: "1.2rem 1.6rem", borderBottom: "1px solid #2a2418" }}>
              <h3 style={{ margin: 0, fontSize: "0.75rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "#c9a84c", fontFamily: "Arial, sans-serif", fontWeight: 400 }}>Proven Civil Law Expertise</h3>
            </div>
