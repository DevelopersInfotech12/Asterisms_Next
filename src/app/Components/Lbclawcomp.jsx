    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className={`bg-white rounded-2xl shadow-2xl overflow-hidden ${isVisible ? 'animate-scaleIn' : 'opacity-0'} stagger-1`}>
          ...
          {/* Header Section */}
          <div className="bg-[#0d1526]/95 p-6 border-b">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div className={`flex items-center gap-3 ${isVisible ? 'animate-slideInLeft' : 'opacity-0'} stagger-2`}>
                ...
                <div>
                  ...
                  <p className="text-gray-400 font-sans font-semibold">Interactive PDF Viewer</p>
                </div>
              </div>
          ...
          <div className="p-6">
            ...
            <div className="mt-6 grid md:grid-cols-2 gap-6">
              <div className={`bg-[#0d1526]/95 p-6 text-white rounded-xl transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isVisible ? 'animate-slideInLeft' : 'opacity-0'} stagger-4`}>
                <h3 className="text-lg font-semibold  mb-3">What's Inside</h3>
                <ul className="space-y-2 text-gray-300 font-sans">
                  {whatsInside.map((item, index) => (
                    <li key={index} className="flex items-center gap-2 transform transition-all duration-300 hover:translate-x-2">
                      <div className="w-2 h-2 bg-indigo-400 text-white rounded-full animate-pulse-slow"></div>
                      {item}
                    </li>
                  ))}
                </ul>
