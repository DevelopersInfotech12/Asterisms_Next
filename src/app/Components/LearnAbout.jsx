...
const LearnAbout = () => {
  ...
  const features = [
    ...
    { icon: <Gavel size={18} />, title: 'Focused Expertise', desc: 'Asterisms Legal firm, personalized strategies' },
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "32px", marginBottom: "16px" }}>
            ...
            <h2 style={{
              ...
              Why{" "}
              <span style={{ color: "#C9A84C", fontStyle: "italic" }}>Asterisms Legal</span>
              {"?"}
            </h2>
            <div style={{ height: "1px", backgroundColor: "#2A2518", flex: 1, maxWidth: "200px" }}></div>
          </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center" }}>
          ...
          <div style={{
            ...
            <p style={{
              ...
              <span style={{ color: "#C9A84C", fontStyle: "italic", fontSize: "18px" }}>Asterisms Legal (AL)</span>{" "}
